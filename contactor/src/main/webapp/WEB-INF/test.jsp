...
<link href="resources/foundation-essentials-5.4.6/css/foundation.css"
	rel="stylesheet">
<link href="resources/foundation-essentials-5.4.6/css/docs.css"
	rel="stylesheet">
<link href="resources/main.css" rel="stylesheet">
<link rel="stylesheet"
	href="resources/magnific-popup/magnific-popup.css">
<link rel="stylesheet"
	href="resources/foundation-essentials-5.4.6/foundation-icons/foundation-icons.css">
...
<body>
 ...
 %> <i class="fi-x"></i>
					...
					<td><a class="editContact-popup-link"
						href="#editContact-popup"> <i class="fi-pencil"></i></a></td>
				</tr>
				...
				<div id="editContact-popup" class="mfp-hide white-popup">
					...
					<form method="post" action="addContact">
						...
						Prenom : <input type="text" style="width: 185px;" maxlength="30"
							name="prenom" id="name" value="<%=contact.getPrenom()%>" /> Nom
						: <input type="text" style="width: 185px;" maxlength="30"
							name="nom" id="name" value="<%=contact.getNom()%>" /> Email: <input
							type="email" style="width: 185px;" maxlength="30" name="email"
							id="email" value="<%=contact.getEmail()%>" /> Date de naissance
						: <input type="text" id="datepicker" style="width: 185px;"
							maxlength="10" name="date"
							value="<%=frenchDate.format(contact.getDate_naissance())%>">

						<input type="submit" class="button" title="Edit"
							value="Sauvegarder" />
					</form>
					<form method="post" action="DeleteContact">
						<input class="button [secondary alert success]" title="Delete"
							value="X Supprimer" />
					</form>
					...
					<h2 style="margin-top: 120px; text-align: center">Vous n'avez
						aucun contact</h2>
